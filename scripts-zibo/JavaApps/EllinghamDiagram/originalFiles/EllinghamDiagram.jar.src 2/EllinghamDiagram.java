...
/*     */   extends PApplet
/*     */ {
/*     */   public EllinghamDiagram.EllinghamPlot plot;
/*     */   EllinghamDiagram.EllinghamBoard board;
/*  32 */   public int W = 800;
/*  33 */   public int H = 600;
/*  34 */   public int D = 541;
...
/*  38 */     size(540, 600);
/*  39 */     smooth();
/*  40 */     this.plot = new EllinghamDiagram.EllinghamPlot(this, 0, 0, this.D, this.H);
/*  41 */     this.board = new EllinghamDiagram.EllinghamBoard(this.plot, this.D + 1, 0, this.W - this.D, this.H);
/*  42 */     ScribePlot();
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/*  49 */     if (this.plot.updated) {
/*  50 */       background(200);
/*  51 */       this.plot.ScribePlot();
/*  52 */       this.board.draw();
/*     */     }
/*  54 */     stroke(100);
/*     */   }
...
/*     */   {
/*  63 */     this.plot.mousePressed();
/*  64 */     this.plot.updated = true;
/*  65 */     ScribePlot();
/*     */   }
/*     */   
/*     */   public void mouseDragged() {
/*  69 */     this.plot.mouseDragged();
/*  70 */     ScribePlot();
/*     */   }
/*     */   
/*     */   public void mouseReleased() {
/*  74 */     this.plot.mouseReleased();
/*  75 */     ScribePlot();
/*     */   }
/*     */   
/*     */   public void test(int paramInt)
/*     */   {
/*  80 */     background(paramInt);
/*     */   }
/*     */   
/*     */   public String getTags() {
/*  84 */     return this.plot.getTags();
/*     */   }
/*     */   
/*     */   public void setHidden(int paramInt, boolean paramBoolean) {
/*  88 */     this.plot.setHidden(paramInt, paramBoolean);
/*  89 */     ScribePlot();
/*     */   }
/*     */   
/*     */   public void addData(float paramFloat1, float paramFloat2, String paramString, float paramFloat3, float paramFloat4) {
/*  93 */     this.plot.addData(paramFloat1, paramFloat2, paramString, paramFloat3 - 273.16F, paramFloat4 - 273.16F);
/*  94 */     ScribePlot();
/*     */   }
/*     */   
/*     */   public boolean getHidden(int paramInt) {
/*  98 */     return this.plot.getHidden(paramInt);
/*     */   }
/*     */   
/* 101 */   public String getValueO() { return String.format("%.3e", new Object[] { Double.valueOf(this.plot.getValueO()) }); }
/* 102 */   public String getValueH() { return String.format("%.3e", new Object[] { Double.valueOf(this.plot.getValueH()) }); }
/* 103 */   public String getValueC() { return String.format("%.3e", new Object[] { Double.valueOf(this.plot.getValueC()) }); }
/*     */   
/*     */ 
...
/*     */     int sizeY;
/*     */     
/*     */     EllinghamBoard(EllinghamDiagram.EllinghamPlot paramEllinghamPlot, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
/*     */     {
...
/*     */     
/*     */     public void draw() {
/* 124 */       EllinghamDiagram.this.pushMatrix();
/* 125 */       EllinghamDiagram.this.translate(this.posX, this.posY);
/* 126 */       EllinghamDiagram.this.noStroke();
/* 127 */       EllinghamDiagram.this.fill(300);
/* 128 */       EllinghamDiagram.this.rect(0.0F, 0.0F, this.sizeX, this.sizeY);
/* 129 */       EllinghamDiagram.this.fill(0);
/* 130 */       EllinghamDiagram.this.textFont(this.plot.font, 12.0F);
/* 131 */       String str = null;
...
/*     */       }
/* 137 */       if (str != null)
/* 138 */         EllinghamDiagram.this.text(str + " : " + String.format("%.3e", new Object[] { Double.valueOf(this.plot.controlValue) }), 20.0F, 20.0F);
/* 139 */       EllinghamDiagram.this.text("... ", 20.0F, 40.0F);
/*     */       
/*     */ 
/* 142 */       EllinghamDiagram.this.popMatrix();
/*     */     }
/*     */     
...
/*     */     
/*     */     EllinghamPlot(PApplet paramPApplet, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
...
/*     */       
/*     */ 
/* 378 */       EllinghamDiagram.this.pushMatrix();
/* 379 */       EllinghamDiagram.this.rotate(-1.5707964F);
/* 380 */       EllinghamDiagram.this.translate(-this.ypos * 2 - this.ysize, 0.0F);
/* 381 */       EllinghamDiagram.this.text("Standard Free Energies of formation of oxides (ΔG)", this.ypos, this.xpos + 10, this.ysize, 25.0F);
/* 382 */       EllinghamDiagram.this.popMatrix();
/*     */       
/* 384 */       EllinghamDiagram.this.textFont(this.font, 12.0F);
/* 385 */       EllinghamDiagram.this.textAlign(3, 3);
/* 386 */       EllinghamDiagram.this.line(this.startx, this.starty, this.endx, this.endy);
/* 387 */       EllinghamDiagram.this.stroke(0.0F, 200.0F, 0.0F);EllinghamDiagram.this.fill(0.0F, 200.0F, 0.0F);
/* 388 */       EllinghamDiagram.this.ellipse(this.startx, this.starty, 4.0F, 4.0F);
/* 389 */       EllinghamDiagram.this.line(this.startx - 3, this.starty, this.startx, this.starty);
/* 390 */       EllinghamDiagram.this.stroke(0.0F, 0.0F, 200.0F);EllinghamDiagram.this.fill(0.0F, 0.0F, 200.0F);
/* 391 */       EllinghamDiagram.this.ellipse(this.startx, this.H, 4.0F, 4.0F);
/* 392 */       EllinghamDiagram.this.stroke(200.0F, 0.0F, 0.0F);EllinghamDiagram.this.fill(200.0F, 0.0F, 0.0F);
/* 393 */       EllinghamDiagram.this.ellipse(this.startx, this.C, 4.0F, 4.0F);
/* 394 */       EllinghamDiagram.this.stroke(0);EllinghamDiagram.this.fill(0);
/* 395 */       EllinghamDiagram.this.line(this.endx - 3, this.endy, this.endx, this.endy);
/* 396 */       EllinghamDiagram.this.text("O", this.startx - 10, this.starty);
/* 397 */       EllinghamDiagram.this.text("H", this.startx - 10, this.H);
/* 398 */       EllinghamDiagram.this.text("C", this.startx - 10, this.C);
/* 399 */       EllinghamDiagram.this.text("0K", this.endx - 10, this.endy);
/*     */       
/*     */ 
/* 402 */       EllinghamDiagram.this.textAlign(37);
/* 403 */       this.labelH.draw(this.HX1, this.HY1 - 3);
/* 404 */       EllinghamDiagram.this.line(this.HX1, this.HY1, this.HX2, this.HY2);
/* 405 */       EllinghamDiagram.this.line(this.HX2, this.HY2, this.HX3, this.HY3);
/* 406 */       EllinghamDiagram.this.line(this.HX3, this.HY3, this.HX4, this.HY4);
/* 407 */       this.labelH.draw(this.HX4, this.HY4 - 3);
/*     */       
/*     */ 
/* 410 */       this.labelC.draw(this.CX1, this.CY1 - 3);
/* 411 */       EllinghamDiagram.this.line(this.CX1, this.CY1, this.CX2, this.CY2);
/* 412 */       EllinghamDiagram.this.line(this.CX2, this.CY2, this.CX3, this.CY3);
/* 413 */       EllinghamDiagram.this.line(this.CX3, this.CY3, this.CX4, this.CY4);
/* 414 */       this.labelC.draw(this.CX4, this.CY4 - 3);
/*     */       
/*     */ 
/* 417 */       this.labelO.draw(this.OX1, this.OY1 - 3);
/* 418 */       EllinghamDiagram.this.line(this.OX1, this.OY1, this.OX2, this.OY2);
/* 419 */       EllinghamDiagram.this.line(this.OX2, this.OY2, this.OX3, this.OY3);
/*     */       
/*     */ 
/* 422 */       if (this.controlO) {
/* 423 */         EllinghamDiagram.this.stroke(0.0F, 200.0F, 0.0F);EllinghamDiagram.this.fill(0.0F, 200.0F, 0.0F);
/* 424 */         EllinghamDiagram.this.line(this.startx, this.starty, this.hOX, this.hOY);
/* 425 */         EllinghamDiagram.this.ellipse(this.hOX, this.hOY, 10.0F, 10.0F);
/*     */       }
/*     */       
/* 428 */       if (this.controlC) {
/* 429 */         EllinghamDiagram.this.stroke(200.0F, 0.0F, 0.0F);EllinghamDiagram.this.fill(200.0F, 0.0F, 0.0F);
/* 430 */         EllinghamDiagram.this.line(this.startx, this.C, this.hCX, this.hCY);
/* 431 */         EllinghamDiagram.this.ellipse(this.hCX, this.hCY, 10.0F, 10.0F);
/*     */       }
/*     */       
/* 434 */       if (this.controlH) {
/* 435 */         EllinghamDiagram.this.stroke(0.0F, 0.0F, 200.0F);EllinghamDiagram.this.fill(0.0F, 0.0F, 200.0F);
/* 436 */         EllinghamDiagram.this.line(this.startx, this.H, this.hHX, this.hHY);
/* 437 */         EllinghamDiagram.this.ellipse(this.hHX, this.hHY, 10.0F, 10.0F); }
/*     */       float f2;
/*     */       float f3;
/*     */       float f4;
...
/*     */         
/* 447 */         EllinghamDiagram.this.fill(255);
/* 448 */         EllinghamDiagram.this.stroke(0);
/* 449 */         if (f4 + 200.0F > this.applet.width)
/* 450 */           f4 -= 80.0F;
/* 451 */         EllinghamDiagram.this.rect(f4 + 5.0F, f5 + 5.0F, 70.0F, 35.0F);
/*     */         
/* 453 */         str2 = formatFloat(f2);
/* 454 */         String str3 = formatFloat(f3);
/* 455 */         EllinghamDiagram.this.fill(0);
/* 456 */         EllinghamDiagram.this.textAlign(37, 101);
/* 457 */         EllinghamDiagram.this.text("T = " + str2, f4 + 10.0F, f5 + 10.0F);
/* 458 */         EllinghamDiagram.this.text("ΔG = " + str3, f4 + 10.0F, f5 + 25.0F);
/*     */       }
/*     */       
...
/* 466 */         EllinghamDiagram.this.stroke(255.0F, 0.0F, 0.0F);
/* 467 */         EllinghamDiagram.this.fill(255.0F, 0.0F, 0.0F);
/* 468 */         EllinghamDiagram.this.ellipse(f4, f5, 8.0F, 8.0F);
/*     */       }
/*     */       
/*     */ 
...
/* 477 */         EllinghamDiagram.this.fill(255);
/* 478 */         EllinghamDiagram.this.stroke(0);
/* 479 */         if (f3 + 200.0F > this.applet.width)
/* 480 */           f3 -= 80.0F;
/* 481 */         EllinghamDiagram.this.rect(f3 + 5.0F, f4 + 5.0F, 70.0F, 35.0F);
/*     */         
/* 483 */         String str1 = formatFloat(f1);
/* 484 */         str2 = formatFloat(f2);
/* 485 */         EllinghamDiagram.this.fill(0);
/* 486 */         EllinghamDiagram.this.textAlign(37, 101);
/* 487 */         EllinghamDiagram.this.text("T = " + str1, f3 + 10.0F, f4 + 10.0F);
/* 488 */         EllinghamDiagram.this.text("ΔG = " + str2, f3 + 10.0F, f4 + 25.0F);
/*     */       }
/*     */       
...
/* 497 */         return (EllinghamDiagram.abs(EllinghamDiagram.this.mouseX - paramInt1) < 8) && (EllinghamDiagram.min(paramInt2, paramInt4) <= EllinghamDiagram.this.mouseY) && (EllinghamDiagram.this.mouseY <= EllinghamDiagram.max(paramInt2, paramInt4));
/* 498 */       if (paramInt2 == paramInt4)
/* 499 */         return (EllinghamDiagram.abs(EllinghamDiagram.this.mouseY - paramInt2) < 8) && (EllinghamDiagram.min(paramInt1, paramInt3) <= EllinghamDiagram.this.mouseX) && (EllinghamDiagram.this.mouseX <= EllinghamDiagram.max(paramInt1, paramInt3));
...
/* 508 */       int k = EllinghamDiagram.this.mouseX - paramInt1;int m = EllinghamDiagram.this.mouseY - paramInt2;
/* 509 */       int n = EllinghamDiagram.this.mouseX - paramInt3;int i1 = EllinghamDiagram.this.mouseY - paramInt4;
...
/* 545 */       int i2 = EllinghamDiagram.this.mouseX - arrayOfInt[0];
/* 546 */       int i3 = EllinghamDiagram.this.mouseY - arrayOfInt[1];
...
/*     */       }
/* 570 */       if (EllinghamDiagram.this.mouseEvent.getClickCount() == 2) {
...
/* 698 */         if ((EllinghamDiagram.abs(EllinghamDiagram.this.mouseX - f3) <= 5.0F) && (EllinghamDiagram.abs(EllinghamDiagram.this.mouseY - f4) <= 5.0F)) {
...
/* 716 */     PApplet.main(new String[] { "--bgcolor=#FFFFFF", "EllinghamDiagram" });
/*     */   }
/*     */ }


/* Location:              /Users/AndrewKanarek/Desktop/MICHIGAN/KiefferWork/scripts-zibo/JavaApps/EllinghamDiagram/EllinghamDiagram.jar!/EllinghamDiagram.class
